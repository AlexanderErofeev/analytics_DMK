...
plus_words = \
    {
        'Преподователь': ['препод', 'учитель', 'tutor', 'тьютор', 'репетитор', 'методист'],
        ...
        'Мусор': ['механик', 'токарь', 'конструктор', 'монтажник', 'переводчик', 'экономист', 'журналист', 'бухгалтер',
                  ...
                  'фотограф', 'режиссер', 'электроснабжен', 'фрезеровщик', 'кабельщик', 'супервайзер', 'мерчендайзер', 'кладовщик', 'сценарист'],
