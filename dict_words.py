minus_words = \
    {
        ...
        'Android-разработчик': ['unity', 'тимлид', 'руководитель', 'qa', 'тим лид', 'manager', 'препод', 'директор',
                                ...
                                'game', 'leader'],
        'Администратор баз данных': ['manager', 'programmer', '1с', 'директор', 'tutor', 'unity', 'developer',
                                     'руководитель', 'инженер', 'qa', '1c', 'teamlead', 'backend', 'erp', 'препод',
                                     'оператор', 'lead', 'тест', 'director', 'leader', 'quality assurance', 'тимлид',
                                     '1 c', '1 с', 'программист', 'разработчик', 'team lead', 'test', 'game'],
        ...
        'ERP-специалист': ['manager', '1с', 'директор', 'unity', 'руководитель', 'qa', '1c', 'teamlead', 'препод',
                           'оператор', 'lead', 'тест', 'director', 'leader', 'quality assurance', 'тимлид', 'баз данн',
                           'team lead', 'test', 'game', 'менджер'],
        '1С-разработчик': ['тимлид', 'руководитель', 'тим лид', 'директор', 'lead', 'teamlead', 'team lead', 'leader'],
        'SAP-разработчик': ['тимлид', 'руководитель', 'тим лид', 'директор', 'lead', 'teamlead', 'team lead',
                            'director', 'leader'],
        'Oracle-разработчик': ['тимлид', 'руководитель', 'директор', 'lead', 'teamlead', 'team lead', 'director',
                               'leader'],
        ...
        'SEO-специалист': [],
        'SMM-специалист': [],
        'Email-маркетолог': ['dev', 'аналитик', 'верстальщик', 'front'],
...
plus_words = \
    {
        ...
        'Web-разработчик': ['web developer', 'веб разработчик', 'web разработчик', 'web programmer', 'web программист', 'веб программист'],
        ...
        'Менеджер IT-проекта': ['product manager', 'менеджер проект', 'project manager', 'менеджер продукт',
                                'менеджер it проект', 'менеджер ит проект', 'менеджер интернет проект', 'продакт менеджер'],
        ...
        'Менеджер по работе с клиентами': ['по работе с корпоративными клиентами', 'по работе с клиентами',
                                           'account manager', 'по сопровождению клиентов', 'account менеджер', 'аккаунт менеджер' ],
        'Менеджер по работе с партнерами': ['менеджер по работе с партнерами'],
        'Менеджер по развитию': ['менеджер по развитию'],
        'Менеджер по маркетингу': ['менеджер по маркетингу', 'marketing manager', 'manager marketing'],
        # 'IT-Специалист': ['it специалист', ],

        'Специалист по интернет-маркетингу': ['internet marketing', 'интернет маркетинг', 'affiliate', 'marketing specialist'],
