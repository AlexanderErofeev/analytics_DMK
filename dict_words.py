...
plus_words = \
    {
        ...
        'Специалист техподдержки': ['техподдер', 'тех поддерж', 'technical support engineer',
                                    'поддержк'],
        'Инженер': ['engineer', 'инженер'],
        'Аналитик': ['analytic', 'аналитик'],
        'Специалист по информационной безопасности': ['информационная безопасность', 'безопасность',
        ...
        'Специалист по интернет-рекламе (Директолог)': ['advisor', 'директолог',
