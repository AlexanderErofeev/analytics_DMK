minus_words = \
    {
        ...
        'Менеджер SoftWare': ['продаж', 'торгов', 'отдел', 'develop', 'разработч', 'программист', 'programmer',
                              ...
                              'writer', 'hr', 'кол', 'привлеч', 'клиент'],
        'Менеджер в отдел снабжения': ['разработчик', 'программист', 'developer'],
...
plus_words = \
    {
        ...
        'Менеджер IT-проекта': ['product manag', 'project manag', 'менеджер проект', 'менеджер продукт', 'менеджер по продукт',
                                ...
                                'менеджер it продукт', 'менеджер it produc'],
        ...
        'Менеджер HardWare': ['асу', 'чпу', 'dcs', 'acs', 'apcs', 'технологическим процесс', 'hardware',
        ...
        'Менеджер SoftWare': ['software', 'корпоративн', 'специалист по программному обеспечен',
                              ...
                              'поддержив', 'corporate'],
        'Менеджер в отдел снабжения': ['снабжен', 'логист', 'отдел разраб', 'отдел технологий', 'отдела технологий',
                                       'отдел систем', 'отдела систем', 'отдел эксплуатац', 'отдела эксплуат',
                                       'отдел мониторинг', 'отдела мониторинг', 'отдел контрол', 'отдела контрол',
                                       'отдел обеспеч', 'отдела обеспеч', 'отдел связ', 'отдела связ',
                                       'отдел обслуживан', 'отдела обслуживан', 'отдел автоматиз', 'отдела автоматиз',
                                       'отдел качеств', 'отдела качеств', 'отдел бизнес', 'отдела бизнес',
                                       'отдела инфраструк'],

        'Маркетолог': ['affiliate', 'маркет', 'market', 'advisor', 'директолог', 'реклам', 'продвижен', 'таргет'],
        'SEO-специалист': ['seo', 'sео'],
        'SMM-специалист': ['smm', 'social media marketing', 'смм', 'таргетолог'],
        ...
        'Мусор': ['механик', 'токарь', 'конструктор', 'монтажник', 'переводчик', 'экономист', 'журналист', 'бухгалтер',
                  ...
                  'call center', 'колл центр', 'менеджер по продажам', 'менеджер продаж', 'специалист по продажам',
                  'sales', 'специалист в отдел продаж', 'менеджер отдела продаж', 'специалист отдела продаж',
                  'менеджер в отдел продаж', 'продаж', 'продавец'],
        ...
        'Инженер': ['engineer', 'инженер', 'інженер'],
