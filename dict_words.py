...
plus_words = \
    {
        ...
        'Desktop-разработчик': ['desktop', 'desktop', 'десктоп', 'c#', 'c sharp', 'c-sharp', 'шарп', 'с#', 'net'],
        ...
        'Администратор баз данных': ['администратор баз данных', 'оператор баз данных', 'базы данных', 'oracle',
                                     'mysql', 'data base', 'dba', 'bd', 'бд'],
        'Devops-инженер': ['devops', 'development operations'],
        'Специалист по анализу данных': ['data scientist', 'data science'],
        'Системный администратор': ['system admin', 'сисадмин', 'сис админ', 'системный админ', 'администратор систем'],
        'Тестировщик (QA-инженер)': ['qa', 'test', 'тест', 'quality assurance'],
        'Специалист техподдержки': ['техподдер', 'тех поддерж', 'technical support engineer', 'поддерж'],
        'Инженер': ['engineer', 'инженер'],
        'Аналитик': ['analytic', 'аналитик'],
        'Специалист по информационной безопасности': ['безопасност', 'защита информ',
                                                      'information security specialist', 'information security'],
        'ERP-специалист': ['erp', 'enterprise resource planning'],
        ...
        'Менеджер по продажам': ['менеджер по продажам', 'менеджер продаж', 'специалист по продажам', 'sales manager', 'специалист в отдел продаж',
                                 'менеджер отдела продаж', 'специалист отдела продаж', 'менеджер в отдел продаж'],
        ...
        'интернет маркетинг'],
        'Интернет-маркетолог': ['internet-market', 'internet market', 'интернет маркетолог'],
        'Специалист по интернет-рекламе (Директолог)': ['advisor', 'директолог', 'интернет-реклам', 'интернет реклам'],
        'SEO-специалист': ['seo'],
        'SMM-специалист': ['smm', 'social media marketing'],
        'Email-маркетолог': ['mail'],

        'C#': ['c#', 'c sharp', 'c-sharp', 'шарп', 'с#'],
        'C C++': ['c++', 'с++'],
        'Delphi': ['delphi', 'делфи'],
