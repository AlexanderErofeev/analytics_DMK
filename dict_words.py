...
plus_words = \
    {
        ...
        'Mobile-разработчик': ['mobile', 'мобайл', 'мобиль', 'мобільний'],#soft
        'IOS-разработчик': ['ios'],#soft
        'Android-разработчик': ['android', 'андроид', 'andorid', 'andoroid', 'andriod', 'andrind', 'xamarin'],#soft
        'Администратор баз данных': ['oracle', 'оракл', 'sql', ['data', 'base'], 'db', 'bd', 'бд',#soft
                                     ['баз', 'данн']],
        'Devops-инженер': ['devops', ['develop', 'operat'], 'devоps'],#soft
        'Специалист по анализу данных': [['data', 'scien'], ['анализ', 'данн'], ['аналит', 'данн'],#soft
                                         # Посмотрим
                                         ['обработ', 'данн']],
        ...
        'Тестировщик (QA-инженер)': ['qa', 'test', 'тест', ['quality', 'assurance']],#soft
        'Специалист техподдержки': [['тех', 'поддерж'], ['technical', 'support', 'engineer'], #soft
        ...
        'Специалист по информационной безопасности': ['безопасност', 'защит', #soft
                                                     ...
                                                     ['фахівець', 'служби', 'безпеки'], # ['cyber', 'security'],
                                                      'security',
                                                      ' иб'],
        'ERP-специалист': ['erp', ['enterprise', 'resource', 'planning'], 'abap', 'crm', 'сrm', # ['crm', 'специалист'], ['crm', 'инженер'], soft
                            # ['crm', 'менедж'], ['crm', 'special'], ['crm', 'manager'],
                           ['help', 'desk'],
                           ['service', 'desk'], ['busin', 'intell'], 'внедрен', 'сопровожден'],
        '1С-разработчик': ['1с', '1c', '1 c', '1 с'], #soft
        'SAP-разработчик': ['sap'], #soft
        ...
        'Менеджер SoftWare': ['software', 'корпоративн', ['програм', 'обеспечен'], #soft
                              'wms'
                              'corporate'],
        'Менеджер обслуживания оборудования': [# Новинка hard
        ...
        # Новинка
        'Инженер-электросвязи': [['инженер', 'электросвязи'], ['инженер', 'электроник'], ['специалист', 'электроник'], #hard
                                 ['специалист', 'электромонтер'], ['специалист', 'электросвязи']
                                 ],
        # Новинка
        'Специалист сетей': [['инженер', 'сет'], ['инженер', 'связ'], ['инженер', 'cisco'], ['инженер', 'cетевой'], #hard
        ...
        'Маркетолог': ['affiliate', 'маркет', 'market', 'advisor', 'директолог', 'реклам', 'продвижен', 'таргет'], # гум
...
hardware = ['Embedded-разработчик', 'Менеджер HardWare', 'Менеджер обслуживания оборудования', 'Инженер-электросвязи',
                 'Специалист сетей', 'Сервисный инженер', 'Оператор станков чпу']
humanitarian = ['Бизнес-специалист', 'Специалист по документации', 'Pre-sale инженер', 'Менеджер по работе с клиентами',
                     'Менеджер по работе с партнерами', 'Менеджер по развитию', 'Менеджер в отделы', 'Маркетолог']
...
rubish_list = ['Мусор', 'Менеджер в отделы', 'Инженер', 'Программист', 'Специалист', 'Менеджер', 'Преподаватель', 'Языки программирования', 'Инженер-электросвязи']
